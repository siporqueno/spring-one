...
public class ProductRepository {
    ...
    public Product findByIdWithBuyers(long id) {
        return executeForEntityManager(em -> em.createNamedQuery("productByIdWithBuyers", Product.class).setParameter("id", id).getSingleResult());
    }
